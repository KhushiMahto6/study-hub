  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-1">Sign in to continue sharing and discovering.</p>
      </div>

      <Button variant="outline" className="w-full rounded-xl gap-2" onClick={google} type="button">
      ...
      <form onSubmit={submit} className="space-y-4">
        ...
        <div className="space-y-1.5">
          ...
          <div className="relative">
            ...
            <Input id="password" type={show ? 'text' : 'password'} required value={password} onChange={(e) => setPassword(e.target.value)} placeholder="••••••••" className="pl-9 pr-9 rounded-xl" />
      ...
      <p className="text-center text-sm text-muted-foreground">
        New to StudyHub? <Link href="/auth/sign-up" className="text-primary font-medium hover:underline">Create an account</Link>
      </p>
    </div>
  );
}
